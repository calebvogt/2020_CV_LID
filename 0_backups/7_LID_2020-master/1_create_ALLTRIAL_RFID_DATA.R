...
wd <- setwd("C:/Users/caleb vogt/Box/0_CV_Shared_Analyses/7_LID_2020/RFID_analysis_v9")
...
for (i in folders[1:7]) {
  ...
  # thus, if an animal from T004 somehow crossed into T005 (which ran simultaneosly), assigned trial for that obs would read T004, while Trial would 
