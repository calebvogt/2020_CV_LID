...
# wd <- setwd("C:/Users/Caleb/Box/CV_Shared_Analyses/7_LID_2020/RFID_DATA/RFID_analysis_v4")
...
# REMAKE PLOTS PLOTS WITH Trial_MOVEBOUT_GBI FOR FIELD DURATION ANALYSIS ETC ----------------------------------------------
