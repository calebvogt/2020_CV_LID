...
setwd("C:/Users/Caleb Vogt/Box/Liddell_2020_RFID")
metadata <- read_excel("Liddell_2020.xlsx", sheet = 1, skip = 1)


# # CHOOSE TRIAL, IMPORT RFID DATA, AND CLEAN -----------------------------------------------------

folders <- list.files("C:/Users/Caleb Vogt/Box/Liddell_2020_RFID", recursive=FALSE, full.names = TRUE)
folders 
